...
class Plot_Creator:
    ...
    def save_plot(self, *args):
        ...
        save_dir = os.path.join(base_dir, 'static', 'images', 'dashboard')
        os.makedirs(save_dir, exist_ok=True)
        #ve se tem mais de 2 argumentos pra fazer o nome
        if len(args) > 2:
            plot_name = f'{args[0]}_{args[1]}_{args[2]}.png'
        elif len(args) == 2:
            plot_name = f'{args[0]}_{args[1]}.png'
        else:
            plot_name = f'{args[0]}.png'
    ...
    def create_plot_range_value(self, crypto_name):
        ...
        plot_path = self.save_plot(crypto_name)
    ...
    def create_plot_history(self, crypto_id, user_id):
        ...
        plot_path = self.save_plot('crypto_history', user_id, crypto_id)
    ...
    def create_plot_spent(self, time, user_id):
        ...
        plot_path = self.save_plot('crypto_spent', user_id, time)
