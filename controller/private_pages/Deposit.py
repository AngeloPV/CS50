...
#status pra redirecionar, ficará true somente qnd o deposito for finalizado
    ...
    def confirm(self):
        ...
        if request.method == 'POST':
            if request.form.get('button'):
                ...
                session['status'] = True
                data = {
                    "msg": 'Depósito finalizado com sucesso'
                }
                url = redirect(url_for("main_routes.route_method", route_name="my_deposits", method="index"))
